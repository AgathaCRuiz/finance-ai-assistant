...
import { ErrorBoundary, ProtectedRoute } from "@/components/auth/ProtectedRoute";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/app/*"  element={<ProtectedRoute><ErrorBoundary><AppShell /></ErrorBoundary></ProtectedRoute>} />
